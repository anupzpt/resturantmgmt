    ...
    $.fn.Tabledit = function(options) {
            ...
            columns: {
                identifier: function() {
                    ...
                    $td.each(function(i) {
                        ...
                        var input = '<input class="tabledit-input tabledit-identifier Number" type="hidden" name="' + settings.columns.identifier[1] + '" value="' + $(this).text() + '" disabled>';
                    ...
                    for (var i = 0; i < settings.columns.editable.length; i++) {
                        ...
                        $td.each(function() {
                            ...
                            if (typeof settings.columns.editable[i][2] !== 'undefined') {
                                ...
                                var input = '<input class="tabledit-input ' + settings.inputClass + '" type="text" name="' + settings.columns.editable[i][1] + '" value="' + $(this).text() + '" style="display: none; width:60px;" disabled>';
                            }
        ...
        var Mode = {
            ...
            edit: function(td) {
                ...
                $(td).find('.tabledit-input').addClass('Number');
