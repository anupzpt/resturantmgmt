...
;(function ( $, window, document, undefined ) {
    ...
    var special_letter = new RegExp('[@#$%&_]');
    ...
    Plugin.prototype._create = function () {
        ...
        this.element.append('<input type="password" name="Password" id="Password" class="form-control required ' + options.inputClass + '" "/>');
        this.element.append('<input type="text" name="Password"  class="form-control ' + options.inputClass + '" style="display:none"/>');
        ...
        this.element.append(
            ...
            <li data-criterion="special_letter" class="valid">At least <strong>one special char</strong></li> \
    ...
    Plugin.prototype._bind_input_events = function($s) {
        ...
        $s.bind('keyup', function () {
            ...
            var special_char = password.match(special_letter) ? 1 : 0;

            var total = characters + capitalletters + loweletters + number + special_letter;
            ...
            that._update_info('special_letter', special_char);
        }).focus(function () {
