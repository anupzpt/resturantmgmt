...
{
    public class CFGenericRepo<TEntity, TKey> : ICFGenericRepo<TEntity, TKey> where TEntity : class
    {
        protected IdentityEntities _db;
        protected DbSet<TEntity> _dbSet;
        protected IQueryable<TEntity> _Query;

        public CFGenericRepo()
        {
        ...
        {
            var data = _dbSet.FirstOrDefault(expression);
            return data;
        }
